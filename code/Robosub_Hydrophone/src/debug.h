...
/* #define __DEBUG_CONSOLE__ */	/* prints are directed to the console window (MUCH SLOWER!!!) */
/**************************************************************/
...
/* if debug printing is enabled */
#if defined(__DEBUG_FILE__) || defined(__DEBUG_UART__) || defined(__DEBUG_CONSOLE__)
	...
	/* else printing to console window */
    #elif defined(__DEBUG_CONSOLE__)
